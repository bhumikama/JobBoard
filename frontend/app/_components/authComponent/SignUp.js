  ...
  return (
    <>
      <div className=" hidden h-max  md:flex justify-between ">
        <div className=" md:flex bg-[url('/login.jpg')] backdrop-opacity-20 bg-cover  w-1/3">
          ...
          >
            ...
            <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
              <p className="text-gray-400 text-sm">
                Already have a <span className="font-semibold">JobHunt</span>{" "}
                Account?{" "}
                <Link
                  href="/login"
      ...
      <div>
        ...
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-white  lg:hidden md:hidden px-3">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="w-full bg-gray-800 bg-opacity-2 backdrop-filter backdrop-blur-xl rounded-2xl  overflow-hidden"
          >
            <div className="p-8">
              <h2 className="mb-6 text-2xl text-center font-semibold text-white">
                Create a JobHunt Account
              </h2>
              <form onSubmit={handleSubmit}>
                <Input
                  icon={User}
